...
## Overview
This project provides a `.bat` script to disable Windows Defender on Windows 10/11.
**Use at your own risk.** Disabling Windows Defender may expose your system to security threats.
